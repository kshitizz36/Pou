  ...
  return (
    ...
    >
      ...
      <div className="overflow-hidden w-full h-full relative z-20">
        <AnimatePresence initial={false}>
          <motion.div
            className="absolute inset-0 z-20 rounded-2xl flex-shrink-0 w-full h-full select-none overflow-hidden"
            style={{
      ...
      <AnimatePresence initial={false}>
        <motion.div className="absolute top-0 left-0 z-[19] rounded-2xl w-full h-full select-none overflow-hidden">
          <SyntaxHighlighter
            language={language}
            style={vscDarkPlus}
            customStyle={{
